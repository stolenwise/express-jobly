...
describe("findAll", function () {
  ...
  test("works: filter by min & max", async function () {
  ...
  test("throws BadRequestError if min > max", async function () {
    await expect(Company.findAll({ minEmployees: 3, maxEmployees: 1 }))
      .rejects
